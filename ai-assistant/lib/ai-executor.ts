...
export async function processAiRequest(
  ...
  const systemLines = [
    ...
    "The earlier messages are the recent conversation in this channel. When the user refers to someone or something indirectly — \"him\", \"her\", \"them\", \"they\", \"that user\", \"it\", or \"tell me more\" — resolve who/what they mean from that recent context, NOT as the person asking. Only \"me\", \"my\", \"myself\", or \"I\" refer to the current asker. If a referent is genuinely unclear, ask who they mean or use get_recent_messages.",
